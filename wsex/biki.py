...
class biki(ExchangeBase):
    ...
    def __init__(self, loop=None, proxy=None, timeout=5, ws_type=WsTypeEnum.kline.value):
        ...
        self.exchange_id = 'biki'   # 唯一key
        self.http_timeout = 5   # 单独设置
        self.ws_timeout = 5     # 单独设置
        self.http_data = {
            'headers': {
    ...
    def get_symbols(self):
        """
        功能:
            此项目所有交易对格式为纯字母: btcusdt
            如果交易所返回或者订阅格式为带/, _ 分隔符的就需要映射: {'btcusdt': 'BTC/USDT'}
        :return:
        """
